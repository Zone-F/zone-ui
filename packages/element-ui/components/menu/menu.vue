<template>
  <div class="zone-menu-wrapper">
    <el-menu :collapse="_collapse" class="zone-menu" v-bind="$attrs">
      <el-menu-item @click="onTitleClick" class="zone-menu-title" v-if="title" index="title">
        <i class="el-icon zone-icon-logo">
          <img class="zone-logo" :src="logo" />
        </i>
        <span slot="title" class="zone-title">{{title}}</span>
      </el-menu-item>
      <slot></slot>
    </el-menu>
